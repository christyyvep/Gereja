...
export const CLOUDINARY_CONFIG = {
  ...
  transforms: {
    'card-mobile': 'w_80,h_80,c_fill,g_center,f_auto,q_auto,dpr_auto',           // 80x80 - HP di NewsPage
    'card-desktop': 'w_400,h_250,c_fill,g_center,f_auto,q_auto,dpr_auto',        // 400x250 - Desktop di NewsPage  
    'detail-mobile': 'w_400,h_250,c_fill,g_center,f_auto,q_auto,dpr_auto',       // 400x250 - HP di DetailNews
    'detail-desktop': 'w_800,h_450,c_fill,g_center,f_auto,q_auto,dpr_auto',      // 800x450 - Desktop di DetailNews
    // Legacy support
    'large': 'w_400,h_250,c_fill,g_center,f_auto,q_auto,dpr_auto',
    'small': 'w_80,h_80,c_fill,g_center,f_auto,q_auto,dpr_auto'
  }
}
...
export function getJadwalCloudinaryUrl(filename, size = 'card-desktop', forceRefresh = false) {
  try {
    ...
    switch (size) {
      case 'card-mobile':
        transform = 'w_80,h_80,c_fill,g_center,f_auto,q_auto,dpr_auto'  // 80x80 untuk mobile card
        break
      case 'card-desktop':
        transform = 'w_400,h_250,c_fill,g_center,f_auto,q_auto,dpr_auto'  // 400x250 untuk desktop card
        break
      case 'detail-mobile':
        transform = 'w_400,h_250,c_fill,g_center,f_auto,q_auto,dpr_auto'  // 400x250 untuk mobile detail
        break
      case 'detail-desktop':
        transform = 'w_800,h_450,c_fill,g_center,f_auto,q_auto,dpr_auto'  // 800x450 untuk desktop detail
        break
      default:
        transform = 'w_400,h_250,c_fill,g_center,f_auto,q_auto,dpr_auto'  // Default ke desktop card
    }
